...
module.exports = {
    commands: ['drop-index'],
    description: 'Drops an index for certain field from a collection.',
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!error) {
                conn.collection(collectionName)
                    .then(col => {
                        col.dropFieldIndex(fieldName).then(() => {
                            resolve(chalk.green(`Field index dropped`));
